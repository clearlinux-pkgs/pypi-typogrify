...
Source0  : https://files.pythonhosted.org/packages/93/8c/b73fe0050bbf67c172b7c6d0c74c356939de0e891e669667f20381c099a8/typogrify-2.1.0.tar.gz
...
%prep
%setup -q -n typogrify-2.1.0
cd %{_builddir}/typogrify-2.1.0
pushd ..
cp -a typogrify-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748371345
...
cp %{_builddir}/typogrify-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-typogrify/518a7cfcd6022fddd68f0fa44294bec8e3857aff || :
...
/usr/share/package-licenses/pypi-typogrify/518a7cfcd6022fddd68f0fa44294bec8e3857aff
